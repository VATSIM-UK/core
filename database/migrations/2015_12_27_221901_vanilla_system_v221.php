...
class VanillaSystemV221 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::table("sys_timeline_action")->insert(array(
            ...
            ["section" => "sys", "area" => "postmaster_queue", "action" => "queued", "version" => 1, "entry" => "Email #{extra} queued for {owner}.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
            ["section" => "sys", "area" => "postmaster_queue", "action" => "parsed", "version" => 1, "entry" => "Email #{extra} parsed and ready to send to {owner}.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
            ["section" => "sys", "area" => "postmaster_queue", "action" => "sent", "version" => 1, "entry" => "Email #{extra} sent to {owner}.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
            ["section" => "sys", "area" => "postmaster_queue", "action" => "sent_by", "version" => 1, "entry" => "{owner} sent email #{extra}.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
            ["section" => "sys", "area" => "postmaster_queue", "action" => "delivered", "version" => 1, "entry" => "Email #{extra} delivered to {owner} successfully.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
            ["section" => "sys", "area" => "postmaster_queue", "action" => "opened", "version" => 1, "entry" => "{owner} opened email #{extra}.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
            ["section" => "sys", "area" => "postmaster_queue", "action" => "clicked", "version" => 1, "entry" => "{owner} clicked a link in email #{extra}.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
            ["section" => "sys", "area" => "postmaster_queue", "action" => "dropped", "version" => 1, "entry" => "Email #{extra} was dropped whilst trying to deliver to {owner}.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
            ["section" => "sys", "area" => "postmaster_queue", "action" => "bounced", "version" => 1, "entry" => "Email #{extra} bounced when trying to deliver to {owner}.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
            ["section" => "sys", "area" => "postmaster_queue", "action" => "spam", "version" => 1, "entry" => "{owner} marked email #{extra} as spam.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
            ["section" => "sys", "area" => "postmaster_queue", "action" => "unsubscribed", "version" => 1, "entry" => "{owner} has unsubscribed from {extra} at our SMTP.", "enabled" => 1, "created_at" => DB::raw("NOW()"), "updated_at" => DB::raw("NOW()")],
