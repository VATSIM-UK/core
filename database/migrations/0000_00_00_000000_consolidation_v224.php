...
class ConsolidationV224 extends Migration
{
    ...
    public function up()
    {
        ...
        if (\Schema::hasTable("mship_qualification") && DB::table('mship_qualification')->where('code', 'P5')->count() == 0) {
