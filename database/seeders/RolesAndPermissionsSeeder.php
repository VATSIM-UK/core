...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            'waiting-lists.offer-training-place.*',
            'waiting-lists.offer-training-place.atc',
            'waiting-lists.offer-training-place.pilot',
            'waiting-lists.rescind-training-place-offer.*',
            'waiting-lists.rescind-training-place-offer.atc',
            'waiting-lists.rescind-training-place-offer.pilot',
