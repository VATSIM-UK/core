...
CREATE TABLE `mship_qualification` (
  ...
  `type` enum('pilot','pilot_military','atc','training_atc','training_pilot','admin','pilot_virtual') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
