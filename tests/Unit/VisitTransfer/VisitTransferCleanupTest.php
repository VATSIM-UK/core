...
class VisitTransferCleanupTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->facility = factory(\App\Models\VisitTransferLegacy\Facility::class, 'atc_visit')->create([
    ...
    public function itOnlyCancelsOldApplications()
    {
        ...
        $this->assertEquals(\App\Models\VisitTransferLegacy\Application::STATUS_EXPIRED, $this->oldApplication->fresh()->status);
        $this->assertEquals(\App\Models\VisitTransferLegacy\Application::STATUS_IN_PROGRESS, $this->newApplication->fresh()->status);
    }
    ...
    public function itLapsesApplicationsForOldContactedReferees()
    {
        ...
        $application = factory(\App\Models\VisitTransferLegacy\Application::class)->create([
            'type' => \App\Models\VisitTransferLegacy\Application::TYPE_VISIT,
            'facility_id' => $this->facility->id,
            'status' => \App\Models\VisitTransferLegacy\Application::STATUS_SUBMITTED,
            'references_required' => 1,
            'submitted_at' => Carbon::now(),
        ]);
        Carbon::setTestNow(Carbon::now()->subDays(15));
        factory(\App\Models\VisitTransferLegacy\Reference::class)->create([
            'status' => \App\Models\VisitTransferLegacy\Reference::STATUS_REQUESTED,
        ...
        Artisan::call('visit-transfer:cleanup');
        $this->assertEquals(\App\Models\VisitTransferLegacy\Application::STATUS_LAPSED, $application->fresh()->status);
    }
    ...
    public function itWontIncorrectlyLapseApplications()
    {
        ...
        $application1 = factory(\App\Models\VisitTransferLegacy\Application::class)->create([
            'type' => \App\Models\VisitTransferLegacy\Application::TYPE_VISIT,
            'facility_id' => $this->facility->id,
            'status' => \App\Models\VisitTransferLegacy\Application::STATUS_SUBMITTED,
            'references_required' => 1,
        ...
        $application2 = factory(\App\Models\VisitTransferLegacy\Application::class)->create([
            'type' => \App\Models\VisitTransferLegacy\Application::TYPE_VISIT,
            'facility_id' => $this->facility->id,
            'status' => \App\Models\VisitTransferLegacy\Application::STATUS_SUBMITTED,
            'references_required' => 1,
        ...
        Artisan::call('visit-transfer:cleanup');
        $this->assertEquals(\App\Models\VisitTransferLegacy\Application::STATUS_SUBMITTED, $application1->fresh()->status);
        $this->assertEquals(\App\Models\VisitTransferLegacy\Application::STATUS_SUBMITTED, $application2->fresh()->status);
    }
}
