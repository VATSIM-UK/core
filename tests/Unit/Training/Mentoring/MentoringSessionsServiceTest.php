...
class MentoringSessionsServiceTest extends TestCase
{
    ...
    #[Test]
    public function check_for_overlapping_bookings_returns_exam_when_session_and_exam_overlap_with_session_taking_priority(): void
    {
        Session::factory()->create([
            'student_id' => $this->studentMember->id,
            'position' => 'EGLL_APP',
    ...
    #[Test]
    public function accept_session_throws_exception_when_overlapping_session_exists(): void
    {
        $pendingSession = Session::factory()->create([
            'student_id' => $this->studentMember->id,
            'position' => 'EGLL_APP',
        ...
        $this->expectExceptionMessage('There is already a mentoring session booked on this position');
    ...
    #[Test]
    public function accept_session_throws_exception_when_overlapping_exam_exists(): void
    {
        Session::factory()->create([
            'student_id' => $this->studentMember->id,
            'position' => 'EGLL_APP',
        ...
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('There is already an exam booked on this position');
