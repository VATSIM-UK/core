...
class BookingTest extends TestCase
{
    ...
    #[Test]
    public function cts_booking_has_core_booking_via_morph_one(): void
    {
        $ctsBooking = CtsBooking::factory()->create([
            'date' => '2026-08-01',
            'from' => '10:00:00',
        ...
        $this->assertInstanceOf(Booking::class, $ctsBooking->coreBooking);
        $this->assertEquals($ctsBooking->id, $ctsBooking->coreBooking->bookable_id);
    }
    ...
    public function exam_booking_has_core_booking_via_morph_one(): void
    {
        ...
        $this->assertInstanceOf(Booking::class, $examBooking->coreBooking);
        $this->assertEquals($examBooking->id, $examBooking->coreBooking->bookable_id);
    }

    #[Test]
    public function session_has_core_booking_via_morph_one(): void
    {
        $session = Session::factory()->create([
            'taken' => 1,
            'taken_date' => '2026-08-01',
        ...
        $this->assertInstanceOf(Booking::class, $session->coreBooking);
        $this->assertEquals($session->id, $session->coreBooking->bookable_id);
    }
}
