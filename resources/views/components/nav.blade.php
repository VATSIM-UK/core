<nav id="nav" class="fixed top-0 left-0 right-0 z-50 bg-nav-bg text-white" x-data="{ mobileMenuOpen: false }"
			...
			@if (currentUserHasAuth())
				<div class="relative flex items-center" x-data="{ open: false, hoverable: window.matchMedia('(hover: hover)').matches }" @mouseenter="hoverable && (open = true)"
					...
					<button type="button" class="nav-trigger-top" @click="open = !open" aria-haspopup="true" :aria-expanded="open">
						...
						<svg class="nav-chevron" fill="currentColor" viewBox="0 0 20 20">
					...
					<div x-show="open" x-cloak x-transition:enter="transition ease-out duration-100"
						...
						<ul class="nav-dropdown-list">
							...
							<li><a class="nav-dropdown-link-static">ATC Rating: <b>{{ Auth::user()->qualification_atc ?: 'OBS' }}</b></a>
							</li>
							<li><a class="nav-dropdown-link-static">Pilot Rating(s):
									<b>{{ Auth::user()->toArray()['pilot_rating'] ?: 'P0' }}</b></a></li>
							<li class="md:hidden"><a href="{{ route('mship.notification.list') }}"
									class="nav-dropdown-link">Notifications</a></li>
							<li class="nav-dropdown-divider"></li>
							...
							<li>
								...
								<a href="{{ route('logout') }}"
									...
									class="nav-dropdown-link">Log Out</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<li class="group relative" x-data="{ open: false, hoverable: window.matchMedia('(hover: hover)').matches }" @mouseenter="hoverable && (open = true)"
						...
						<div x-show="open" x-cloak x-transition:enter="transition ease-out duration-100"
							...
							<ul class="nav-dropdown-list">
								...
								<li><a href="https://moodle.vatsim.uk/course/index.php?categoryid=29" class="nav-dropdown-link">eLearning</a>
								</li>
					...
					<li class="group relative" x-data="{ open: false, hoverable: window.matchMedia('(hover: hover)').matches }" @mouseenter="hoverable && (open = true)"
						...
						<div x-show="open" x-cloak x-transition:enter="transition ease-out duration-100"
							...
							<ul class="nav-dropdown-list">
								...
								<li><a href="https://moodle.vatsim.uk/course/index.php?categoryid=3" class="nav-dropdown-link">eLearning</a>
								</li>
							...
							<ul class="nav-dropdown-list border-t border-white/20 mt-2">
								...
								<li><a href="{{ route('controllers.endorsements.heathrow_ground_s1') }}" class="nav-dropdown-link">Heathrow
										Ground (S1)</a></li>
					...
					<li class="group relative" x-data="{ open: false, hoverable: window.matchMedia('(hover: hover)').matches }" @mouseenter="hoverable && (open = true)"
						...
						<div x-show="open" x-cloak x-transition:enter="transition ease-out duration-100"
							...
							<ul class="nav-dropdown-list">
								...
								<li><a href="{{ route('site.policy.community-standards') }}" class="nav-dropdown-link">Community
										Standards</a></li>
								<li><a href="{{ route('site.policy.privacy') }}" class="nav-dropdown-link">Privacy Policy</a></li>
								<li><a href="{{ route('site.policy.data-protection') }}" class="nav-dropdown-link">Data Protection Policy</a>
								</li>
								<li class="nav-dropdown-divider"></li>
					...
					<li class="group relative" x-data="{ open: false, hoverable: window.matchMedia('(hover: hover)').matches }" @mouseenter="hoverable && (open = true)"
						...
						<div x-show="open" x-cloak x-transition:enter="transition ease-out duration-100"
							...
							<ul class="nav-dropdown-list">
								...
								<li class="nav-dropdown-divider"></li>
								<li><a href="{{ route('filament.training.pages.dashboard') }}" class="nav-dropdown-link">Training System</a>
								</li>
