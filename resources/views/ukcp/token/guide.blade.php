		...
		<div class="col-md-4 col-md-offset-2">
			<div class="panel panel-ukblue">
				...
				<div class="panel-body">
					...
					<br />
					<a href="https://github.com/VATSIM-UK/uk-controller-plugin/releases/" target="_blank">
					...
					The plugin relies on <a
						href="https://support.microsoft.com/en-gb/help/2977003/the-latest-supported-visual-c-downloads" target="_blank">a
						package from Microsoft</a>. You can download that below too.
					<br />
					<a href="https://aka.ms/vs/17/release/VC_redist.x86.exe" target="_blank">
						<br />
			...
			<div class="panel panel-ukblue">
				...
				<div class="panel-body">
					<ol>
						...
						<li>If this is your first time setting up the plugin, see the Step Three for configuring your
	...
	<div class="row equal">
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-ukblue">
				...
				<div class="panel-body">
					When loading the plugin into EuroScope for the first time, you will be asked to login to the VATSIM UK
					website.
					Doing this will allow the plugin to receive your personal plugin credentials, which are required to
					authenticate
					actions such as assigning squawk codes.<br />
					<br />

					If you would like to generate a fresh key, you may do so using the option in the "OP" menu on the bottom
					right of the
					...
					<p>Having trouble or got questions? Ask on <a href="{{ route('mship.manage.dashboard') }}">our
							Discord</a>!</p>
				</div>
			</div>
		</div>
