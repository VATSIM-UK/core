...
@section('body')
    <p>
        A new {{ $application->type_string }} application for {{ $application->facility->name }} has been accepted by the
    ...
    <p>
        ...
        {{ $application->statement_required ? $application->statement : 'None required for this facility' }}
    </p>
