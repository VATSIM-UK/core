            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <button class="btn btn-danger pull-right" data-toggle="modal" data-target="#modalApplicationCancel">Mark Application Cancelled</button>
                        @endcan

                        @can("complete", $application)
                        <button class="btn btn-info pull-right margin-r-5" data-toggle="modal" data-target="#modalApplicationComplete">Mark Application Complete</button>
                        @endcan
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr class="bg-{{ $application->references_accepted->count() == $application->references_required ? "success" : "danger" }}">
                                ...
                                <th>
                                    @if($application->references_required < 1) References <strong class="text-danger">are not required</strong>.
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>
                    You must enter a reason why you are cancelling this application. This message <strong>will</strong> be
