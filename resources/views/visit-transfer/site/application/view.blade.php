                    ...
                    @if ($application->will_auto_accept && $application->is_submitted)
                        <div class="alert alert-success" role="alert">
                            <p>
                                ...
                                notified of the outcome within the next
                                {{ $application->submitted_at->addHours(1)->diffInMinutes(\Carbon\Carbon::now()) }}
                                minutes.
                            </p>
                        </div>
                    @endif
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    @elseif($application->is_cancelled)
                        ...
                        @elseif($application->is_accepted)
                            <div class="alert alert-warning" role="alert">
                                <p>
                                    Congratulations, your application has been accepted! You will be contacted to discuss
                                    the next steps.
                                </p>
                                @if ($application->training_required)
                                    <p class="text-danger">
                                        Your application cannot be completed without receiving training from the
                                        {{ strtoupper($application->training_team) }} department.
                        ...
                        @else<div class="alert alert-info" role="alert">
                                <p>
                                    Your application is currently undergoing some final automated checks. It will
                                    automatically be submitted for review once these are complete.
                                </p>
                            </div>
                    @endif
                </div>
