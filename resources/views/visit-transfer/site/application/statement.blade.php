            ...
            <form action="{{ route('visiting.application.statement.post', $application->public_id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <p>
                            Please justify your application to the facility
                            (<strong>{{ $application->facility->name }}</strong>) in the space provided below.
                            Remember to explain what your motivation is for applying to
                            {{ $application->is_visit ? 'visit' : 'transfer to' }}
                            <strong>{{ $application->facility->name }}</strong>.
                        </p>
                    </div>
