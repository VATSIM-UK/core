					...
					<div class="col-md-10 col-md-offset-1 text-center">
						<div class="form-group row">
							<label for="submission_terms">
								I confirm that the details within this application are correct to the best of my knowledge
								and that my application will be rejected if any details are inaccurate. I understand that
								after I submit this application I will not be able to amend any details and in the event of
								any details being incorrect, I will need to start a new application.&nbsp;&nbsp;
							</label>
