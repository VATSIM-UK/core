			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					...
					@if ($application->status == \App\Models\VisitTransfer\Application::TYPE_VISIT)
						...
						<ul>
							<li>Should you apply to a facility where <span class="label label-warning" id="labelTrainingHelp">TRAINING IS
									REQUIRED</span>
		...
		<div class="col-md-4">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<form action="{{ route('visiting.application.facility.manual.post', $application->public_id) }}" method="POST"
						class="form-inline">
						@csrf
			...
			<div class="col-md-3">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<form action="{{ route('visiting.application.facility.post', $application->public_id) }}" method="POST">
							@csrf
