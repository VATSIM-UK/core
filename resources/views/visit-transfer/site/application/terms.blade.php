...
@section('vt-content')
    <div class="row" id="termsBoxHelp">
        <div class="col-md-12">
            ...
            <div class="hidden-xs">
                <p>
                    Before you can start your application, you must first read and agree to the terms and conditions of
                    the
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    @if($applicationType == \App\Models\VisitTransferLegacy\Application::TYPE_TRANSFER)
                        <div class="form-group">
