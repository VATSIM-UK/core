...
@section('styles')
	...
	<style type="text/css">
		#accordion .panel-heading-link:hover,
		#accordion .panel-heading-link:focus {
			color: white;
		}
		...
		<div class="col-md-8">
			<div class="panel panel-ukblue">
				<div class="panel-heading"><span class="panel-heading-lg">{{ $airport->name }}</span>
					...
					<span class="panel-heading-lg-secondary">{{ $airport->iata }}</span>
				</div>
					...
					<div class="panel-body">
						<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							@if ($airport->departure_procedures)
								<div class="panel panel-ukblue">
									<a class="collapsed panel-heading-link" role="button" data-toggle="collapse" data-parent="#accordion"
										href="#departureProcedures" aria-expanded="false" aria-controls="departureProcedures">
										<div class="panel-heading" role="tab"
											style="background-image:url({{ asset('images/slice_departure.jpg') }});">
											<h4 class="panel-title"><span class="fa fa-plane-departure"></span> Departure
												Procedures</h4>
										</div>
									</a>
							...
							@if ($airport->arrival_procedures)
								<div class="panel panel-ukblue">
									<a class="collapsed panel-heading-link" role="button" data-toggle="collapse" data-parent="#accordion"
										href="#arrivalProcedures" aria-expanded="false" aria-controls="arrivalProcedures">
										<div class="panel-heading" role="tab"
											style="background-image:url({{ asset('images/slice_arrival.jpg') }});">
											<h4 class="panel-title"><span class="fa fa-plane-arrival"></span> Arrival
												Procedures</h4>
										</div>
									</a>
							...
							@if ($airport->vfr_procedures)
								<div class="panel panel-ukblue">
									<a class="collapsed panel-heading-link" role="button" data-toggle="collapse" data-parent="#accordion"
										href="#vfrProcedures" aria-expanded="false" aria-controls="vfrProcedures">
										<div class="panel-heading" role="tab" style="background-image:url({{ asset('images/slice_vfr.jpg') }});">
			...
			<div class="col-md-4">
				<div class="panel panel-ukblue">
					...
					<div class="text-summary panel-body">
						...
						<a id="additionalInfoController" class="summary-controller collapsed" data-toggle="collapse"
							href="#additionalInformationContainer" aria-expanded="false" aria-controls="additionalInformationContainer"></a>
					</div>
				</div>
			</div>
		@endif
		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-ukblue">
					...
					<div class="text-summary panel-body">
						<iframe class="w-100" style="min-height:80vh;width:100%"
							src="https://api.chartfox.org/v2/interfaces/airport/{{ $airport->icao }}?token={{ config('services.chartfox.public_token') }}"></iframe>
					</div>
				</div>
									...
									<tr>
										...
										<td>
											...
											@elseif($stand['status'] === 'requested')
												<span style="color:#9744FD">Requested by
													{{ $stand['requested_by'][0] }}</span>
											@endif
										</td>
									</tr>
								@endforeach
