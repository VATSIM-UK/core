                    ...
                    <div class="panel-body">
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            @if ($airport->departure_procedures)
                                <div class="panel panel-ukblue">
                                    <a class="collapsed panel-heading-link" role="button" data-toggle="collapse"
                                        data-parent="#accordion" href="#departureProcedures" aria-expanded="false"
                                        aria-controls="departureProcedures">
                            ...
                            @if ($airport->arrival_procedures)
                                <div class="panel panel-ukblue">
                                    <a class="collapsed panel-heading-link" role="button" data-toggle="collapse"
                                        data-parent="#accordion" href="#arrivalProcedures" aria-expanded="false"
                            ...
                            @if ($airport->vfr_procedures)
                                <div class="panel panel-ukblue">
                                    <a class="collapsed panel-heading-link" role="button" data-toggle="collapse"
                                        data-parent="#accordion" href="#vfrProcedures" aria-expanded="false"
                ...
                <div class="panel panel-ukblue">
                    ...
                    <div class="text-summary panel-body">
                        ...
                        <a id="additionalInfoController" class="summary-controller collapsed" data-toggle="collapse"
                            href="#additionalInformationContainer" aria-expanded="false"
                            aria-controls="additionalInformationContainer"></a>
                    </div>
                </div>
            </div>
        @endif
