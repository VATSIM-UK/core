...
@section('content')
	...
	<div class="row row-flex">
		...
		<div class="col-md-8 col-md-offset-2">
			<img class="img-responsive center-block" src="/images/pilottrainingheader.png" />
		</div>
			...
			<div class="panel panel-ukblue">
				...
				<div class="panel-body">
					@if (Auth::user() && $_account->primary_state->code == 'DIVISION')
						<strong>{{ $_account->name_first }}</strong>, <strong>you are</strong> a Division member, so that
						you can get started straight away!<br />
		...
		<div class="col-md-4 col-md-offset-2" @if (Auth::user() && $_account->primary_state->code !== 'DIVISION') style="opacity: 0.3" @endif>
			<div class="panel panel-uk-success">
				...
				<div class="panel-body">
					<ol>
						<li>
							Join the waiting list <a href="{{ route('mship.waiting-lists.index') }}" target="_blank"
								rel="noopener noreferrer">here</a>
						</li>
						<li>
							Sign up to the P1 PPL(A) moodle course <a href="https://moodle.vatsim.uk/course/view.php?id=51" target="_blank"
								rel="noopener noreferrer">here</a>.
						</li>
						<li>
						...
						<li>
							Notify us <a href="https://helpdesk.vatsim.uk/open.php" target="_blank" rel="noopener noreferrer">here</a> that
							you have completed the Theory Phase of the P1 PPL(A)
							Moodle course.
						</li>
						<li>
		...
		<div class="col-md-4" @if (Auth::user() && $_account->primary_state->code == 'DIVISION') style="opacity: 0.3" @endif>
			<div class="panel panel-uk-danger">
				...
				<div class="panel-body">
					<ol>
						<li>
							<a href="{{ route('visiting.landing') }}" rel="noreferrer noopener">Apply to visit as a
								Pilot</a>, not seeing the option you want? Submit a ticket <a href="https://helpdesk.vatsim.uk/open.php"
						...
						<li>
							Notify us <a href="https://helpdesk.vatsim.uk/open.php" target="_blank" rel="noreferrer noopener">here</a> that
							you have completed the Theory Phase of the P1 PPL(A)
							Moodle course.
						</li>
						<li>
