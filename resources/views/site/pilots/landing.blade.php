            ...
            <div class="panel panel-uk-success">
                ...
                <div class="panel-body">
                    <ol>
                        ...
                        <li>
                            Notify us <a href="https://helpdesk.vatsim.uk/open.php" target="_blank"
                                rel="noopener noreferrer">here</a> that you have completed the Theory Phase of the P1 PPL(A)
                            Moodle course.
                        </li>
                        <li>
                    ...
                    <ol>
                        <li>
                            <a href="{{ route('visiting.landing') }}" rel="noreferrer noopener">Apply to visit as a
                                Pilot</a>, not seeing the option you want? Submit a ticket <a
                                href="https://helpdesk.vatsim.uk/open.php" target="_blank"
                        ...
                        <li>
                            Notify us <a href="https://helpdesk.vatsim.uk/open.php" target="_blank"
                                rel="noreferrer noopener">here</a> that you have completed the Theory Phase of the P1 PPL(A)
                            Moodle course.
                        </li>
                        <li>
                            Sit tight! We will be in touch when a training place becomes available.
