        ...
        <div class="col-md-8 col-md-offset-2 ">
            <div class="panel panel-ukblue">
                ...
                <div class="panel-body">
                    ...
                    <p>
                        A student can request an <b>IFR route</b> from our list of beginner friendly flights, available as a pinned comment in the students’ channel. These routes have been planned and verified by the Pilot Training team for their short duration (under 1 hour flight time) and simple procedures (eg SIDs, STARs).
                    </p>
                    ...
                    <p>
                        Members with the relevant Flying Programme permissions to book a slot in CTS and will be allocated a specific flight number for the flight, with the ficticious callsign ‘<b>TANGENT</b>’. Members who have not enrolled via CTS are still welcome to attend the group flight and be in the Discord channel.
                    </p>
                    ...
                    <p>
                        Group seminars will be hosted regularly on a rotating series of topics. Additionally, event-specific briefings for events in the UK such a <i>Cross the Pond</i> will be held.
                    </p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div>
                                ...
                                <p>
                                    Any feedback on the course can be sent via the <a href="https://helpdesk.vatsim.uk/" rel="external nofollow noopener" target="_blank">Helpdesk</a> (Help Topic: Pilot Training).
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div>
                                ...
                                <p>
                                    Want to sign up? Send us a ticket via the <a href="https://helpdesk.vatsim.uk/" rel="external nofollow noopener" target="_blank">Helpdesk</a> (Help Topic: Pilot Training) and the Initial Flight Instructor will coordinate with you to arrange an Over-The-Shoulder (OTS session).
                                </p>
                            </div>
                        </div>
                    </div>
