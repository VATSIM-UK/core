            ...
            <div class="panel panel-ukblue">
                ...
                <div id="endorsement-heathrow-s1" class="panel-collapse collapse panel-body">
                    ...
                    <p>
                        ...
                        S1 rated members that have 50 hours on any UK ground or delivery positions may train for a Heathrow
                        Ground (S1) Endorsement.
                    </p>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-ukblue">
                ...
                <div id="endorsement-afis" class="panel-collapse collapse panel-body">
                    ...
                    <ol>
                        <li>In order to be eligible to take the Moodle exam, the member must have acquired a total of 50
                            hours controlling on ground and delivery positions in the UK</li>
                        <li>Once the hour requirement is met, the member submits a ticket to the helpdesk asking to be
                            enrolled in the Moodle exam</li>
                        <li>The member must pass the exam at the end of the Moodle course and informs the training
                            department via the helpdesk that they have passed.</li>
                    </ol>
                    ...
                    <ul>
                        ...
                        <li>Stanley (SFAL) - see <a
                                href="https://docs.vatsim.uk/General/Letters%20of%20Agreement/">Argentina LoA</a></li>
                    </ul>

                    <h3>Get Started</h3>

                    <p>
                        Once you have met the minimum hour requirement for taking the Moodle exam, <a
                            href="https://helpdesk.vatsim.uk">submit a ticket</a>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-ukblue">
                ...
                <div id="endorsement-heathrow" class="panel-collapse collapse panel-body">
                    View the details for the Heathrow endorsements by <a class="nav-link"
                        href="{{ route('site.atc.heathrow') }}">clicking here</a>.
            ...
            <div class="panel panel-ukblue">
                ...
                <div id="endorsement-mil" class="panel-collapse collapse panel-body">
                    ...
                    <ul>
                        ...
                        <li>EGVV_CTR - 133.900 - Swanwick Military - Covers military activity in both EGTT and EGPX, as well
                            as top-down control for Military airfields</li>
                        <li>EGVV_x_CTR - Swanwick Military - Various other splits.</li>
                        <li>ISLAND_CTR - Island Radar - Provides radar services to aircraft within the Falklands Control
                            Zone, and top-down control for EGYP.</li>
                    </ul>

                    <h3>Requirements</h3>

                    <p>
                        In order to be able to be eligible for military endorsement, a controller must meet the following
                        requirements.
                    </p>
                    ...
                    <ul>
                        ...
                        <li>Must hold the equivalent permanent controller rating to the endorsement that they wish to
                            undertake</li>
                    </ul>
                    ...
                    <ol>
                        <li><a href="https://helpdesk.vatsim.uk">Submit a ticket</a> to ATC Training in the helpdesk,
                            requesting to have the exam enabled on the relevant self study course</li>
                        <li>Complete the online self-study course and pass the exam at the end</li>
                        <li>Upon completing the exam, submit a ticket to the helpdesk, stating that the course has been
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-ukblue">
                ...
                <div id="endorsement-oceanic" class="panel-collapse collapse panel-body">
                    ...
                    <ol>
                        <li>Enroll on the Shanwick Oceanic <a href="https://moodle.vatsim.uk/course/view.php?id=35">online
                                Moodle course</a></li>
                        <li>Complete the Moodle course and pass the final exam</li>
                        <li>Practical training - there is no formal assessment, so mentors will issue the endorsement once
                            competency is demonstrated.</li>
                    </ol>
            ...
            <div class="panel panel-ukblue">
                ...
                <div id="endorsement-londonbbx" class="panel-collapse collapse panel-body">
                    ...
                    <ul>
                        ...
                        <li>An additional <strong>20 hours</strong> post-C1 on any UK CTR position (including those above).
                        </li>
                    </ul>
                    ...
                    <p>
                        ...
                        covering the major aerodromes, or to cover off remaining sectors when other London positions are
                        open.
                    ...
                    <p>
                        If you wish to apply for a London Bandbox endorsement, please <a
                            href="https://helpdesk.vatsim.uk">open
