			...
			<div class="panel panel-ukblue">
				...
				<div class="panel-body">
					...
					<p>
						...
						a student who performs very strongly in an S3 exam may be invited to mentor on approach sooner, as
						consolidation at this point becomes a box ticking exercise. This requirement is also particularly
					...
					<ul>
						...
						<li>
							<strong>Covered</strong> - Key facts and concepts can be recalled, with some understanding
							shown. If the
							student has demonstrated practical application, it will be with significant mentor input.
						</li>
						<li>
							<strong>Developing</strong> - Knowledge is satisfactorily applied to practical situations with
							some mentor
						...
						<li>
							<strong>Good</strong> - Routine situations are handled with little mentor input; more uncommon
							situations
						...
						<li>
							<strong>Test Standard</strong> - Most situations are handled with minimal mentor input.
							Appropriate
					...
					<p>
						Advertisements for mentoring sessions and specific requests may be made in the relevant channels in
						our Discord.
					</p>
