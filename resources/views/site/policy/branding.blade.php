				...
				<div class="panel panel-ukblue">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="col-md-4">
									<img class="img-responsive center-block" src="/images/branding/different_colour.png">
									<p class="text-center">Do not change the colours of our logo</p>
								</div>
								<div class="col-md-4">
									<img class="img-responsive center-block" src="/images/branding/rotate.png">
									<p class="text-center">Do not rotate or flip our logo</p>
								</div>
								<div class="col-md-4">
									<img class="img-responsive center-block" src="/images/branding/stretch.png">
									<p class="text-center">Do not stretch the width/height of our logo</p>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="col-md-4">
									<img class="img-responsive center-block" src="/images/branding/old.png">
									<p class="text-center">Do not use old variations of our logo</p>
								</div>
								<div class="col-md-4">
						...
						<h4>Example Banners</h4>

						<div class="col-md-12">
							<div class="col-md-6">
								<img class="img-responsive center-block" src="/images/branding/good_banner.png">
							...
							<div class="col-md-6">
								<img class="img-responsive center-block" src="/images/branding/poor_banner.png">
								<p class="text-center">Example of a poor banner</p>
								<ul>
	...
	<div class="col-md-3">
		<div class="panel panel-ukblue">
			...
			<div class="panel-body">
				...
				<h4>Approved Logos</h4>

				<ul>
					<li>
						<a href="/images/branding/vatsimuk_blackblue.png" rel="">VATSIM UK Black &amp; blue</a>
					</li>
					<li>
						<a href="/images/branding/vatsimuk_whiteblue.png" rel="">VATSIM UK White &amp; blue</a>
					</li>
					<li>
						<a href="/images/branding/vatsimuk_black.png" rel="">VATSIM UK All black</a>
					</li>
					<li>
						<a href="/images/branding/vatsimuk_white.png" rel="">VATSIM UK All white</a>
					</li>
				</ul>
				...
				<ul>
					<li>
						Headers use Alegre Sans - <a href="http://www.dafont.com/alegre-sans-nc.font" rel="external nofollow"
				...
				<p>
				<div style="width: 150px; height: 25px; background-color: #25ADE3;"></div>
				</p>

				<ul>
					<li>
						<strong>HEX</strong> 25ADE3
					</li>
					<li>
						<strong>RGB</strong> 37 / 173 / 227
					</li>
					<li>
						<strong>HSV</strong> 197 / 83 / 89
					</li>
				</ul>

				<p>
				<div style="width: 150px; height: 25px; background-color: #17375E;"></div>
				</p>

				<ul>
					<li>
						<strong>HEX</strong> 17375E
					</li>
					<li>
						<strong>RGB</strong> 23 / 55 / 94
					</li>
					<li>
