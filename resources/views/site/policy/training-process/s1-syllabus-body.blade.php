<x-markdown>
    ...
    **Effective Date:** 01st November 2025
    ...
    This document outlines the syllabus and lesson structure for VATSIM United Kingdom Division Observer to Student 1
    controller training (OBS-S1).
    ...
    The following list contains the theoretical content covered in the [S1 | Aerodrome
    Control](https://moodle.vatsim.uk/course/view.php?id=67) e-learning course.
    ...
    - Consider local taxiways and apron restrictions (width, runway infringement, etc) when issuing ground movement
    instructions
    ...
    - Use the UK Standard Route Document and/or its associated UKCP function to identify and correct invalid flight plan
    routings up to the EGTT/EGPX FIR boundary
    ...
    - Issue instructions with phraseology detailed in the [S1 | Aerodrome
    Control](https://moodle.vatsim.uk/course/view.php?id=67) e-learning course and
    [CAP413](https://www.caa.co.uk/our-work/publications/documents/content/cap-413), including:
    - Taxi instructions
    - Level instructions
    ...
    - Contact a supervisor using the `.wallop` command, and provide them with appropriate information to resolve an
    issue
    ...
    - Describe in detail the areas of responsibilities (as per the [S1 | Aerodrome
    Control](https://moodle.vatsim.uk/course/view.php?id=67) e-learning course and
    [CAP413](https://www.caa.co.uk/our-work/publications/documents/content/cap-413)) of:
    - Ground Movement Planner (GMP)
    - Ground Movement Control (GMC)
    - Air Control (AIR)
    - Describe in basic terms the areas of responsibilities (as per the [S1 | Aerodrome
    Control](https://moodle.vatsim.uk/course/view.php?id=67) e-learning course and
    [CAP413](https://www.caa.co.uk/our-work/publications/documents/content/cap-413)) of:
    ...
    - Select an appropriate runway for use - in the absence of a controller covering the duties of the AIR controller -
    based on:
    - The surface wind
    ...
    The student should be able to use the 'red carpet rule' when issuing ground movement instructions to identify and
    ...
    - State the purpose of Visual Reference Points (VRPs) and CTR entry/exit lanes, and correctly includ these in
    ...
    The lesson plans presented below should be taught to students in the order that they are presented in this document.
    At the end of each lesson, if a learning objective/aim has not been covered or met, mentors are requested to note
    this in the 'additional comments' box of the mentoring report.

    There are times where it may be beneficial to repeat a specific lesson or set of lessons, or combine lessons.
    Mentors are encouraged to do this where it is beneficial to do so.

    At the beginning of each session, whether it is one of the lessons in this document, or an ad-hoc lesson, outline to
    the student what the objectives of the lesson are, and how we intend to achive them. This may include running though
    the 'Aims' section of the lesson plan. This may also be a simple recognition that the purpose of the lesson is to
    get a feel for where the student is, or to see what issue arise in the session. Nevertheless, the importance of a
    clear brief cannot be stressed enough.

    After the completion of lesson 4, a student should be in a good position to pass their exam. If further lessons are
    required after the completion of lesson 4, mentors should list the aims of any further ad-hoc mentoring sessions in
    the 'additional comments' box.

    These lessons have been designed to be used in conjunction with a specific SweatBox file, listed at the top of each
    lesson. Each lesson has different objectives that must be met in order to complete the lesson.

    The SweatBox files contain deliberate mistakes that can be used to demonstrate selected areas of the syllabus, and
    ultimately achieve the objectives set out for each lesson. For example, some aircraft in lesson 2 have flight
    planning errors in their routing, RFL, and initial fix.

    As a mentor, you can use the aircraft in the SweatBoxes to help you demonstrate the objectives of the lesson to the
    student. Some objectives may not be met practically, and therefore should be taught in the theory section of the
    session.
    ...
    | Objectives | 1. Connect to SweatBox</br>2. Discuss the roles and aeras of responsibilities of the GMP, GMC, and
    AIR controllers</br>3. Select a runway for use</br>4. Talk though the aerodrome layout and 'standard' taxi
    routings</br>5. Practise coordinating an initial logon to the network</br>6. Generate an ATIS</br>7. Explain the use
    of status blocks and scratch pads. Give a brief introduction to how scratchpads can be used, but emphasiese that the
    student can use them however they want</br>8. Explain and practise issing IFR clearances and mandatory readback
    items</br>9. Explain and practise using push-back and start-up instructions</br>10. Explain and practise issuing
    taxi instructions</br>11. Define and practise using the correct handoff procedure |
    | Student notes and resources | [S1 - Aerodrome Control e-learning
    course](https://moodle.vatsim.uk/course/view.php?id=67)</br>[Aeronautical Chart
    Symbols](https://www.aurora.nats.co.uk/htmlAIP/Publications/2021-01-28-AIRAC/html/eAIP/EG-GEN-2.3-en-GB.html#GEN-2.3)
    |
    ...
    | Environment | SweatBox |
    | Duration | 1 - 1.5 hours |
    | Objectives | Navigate to the eAIP and discuss the different chart types and their features.</br>2. Introduce basic
    altimetry - definitions of QNH and QFE and where they are used</br>3. Discuss the basic area of responsibilities of
    adjacent control positions (AIR, APC, FIN, INT, TC, and AC), and what they do, how they appear in EuroScope, and
    examples of when you might co-ordinate with them</br>4. Highlight any lateral and vertical flight plan restrictions
    specific to the student's training aerodrome</br>5. Recognise errors in flight plans such as initial routings for a
    SID, RFL for direction of flight, RFL for standing agreements</br>6. Explain and practise using conditional
    clearances</br>7. Introduce VFR clearances for the circuit and CTR entry/exit</br>8. Consolidate objectives from
    previous lessons |
    | Student notes and resources | [S1 - Aerodrome Control e-learning
    course](https://moodle.vatsim.uk/course/view.php?id=67)</br>[Standard Route Document
    (SRD)](https://nats-uk.ead-it.com/cms-nats/opencms/en/Publications/digital-datasets/)</br>[UKCP SRD
    search](https://ukcp.vatsim.uk/srd-routes)</br>[eAIP](https://nats-uk.ead-it.com/cms-nats/opencms/en/Publications/AIP/)
    |
    ...
    | Environment | SweatBox |
    | Duration | 1 - 1.5 hours |
    | Objectives | 1. Introduce low visibility procedures and talk though the local procedures associated with
    them</br>2. Introduce METARs and TAFs, and practise decoding simple examples</br>3. Introduce non-standard IFR
    clearances (airway departures, vectored departure) and practise issuing them.</br>4. Introduce the use of the
    command line - aliases, private messaging, function keys</br>5. Consolidate objectives from previous lessons |
    | Student notes and resources | [S1 - Aerodrome Control e-learning
    course](https://moodle.vatsim.uk/course/view.php?id=67)</br>[Standard Route Document
    (SRD)](https://nats-uk.ead-it.com/cms-nats/opencms/en/Publications/digital-datasets/)</br>[UKCP SRD
    search](https://ukcp.vatsim.uk/srd-routes)</br>[eAIP](https://nats-uk.ead-it.com/cms-nats/opencms/en/Publications/AIP/)</br>[METAR
    bank](https://docs.google.com/spreadsheets/d/1WfveAfGmAg_qFpZjx5k55XKTnVqtxlJTN_Vf9XwPtNM/edit?usp=sharing) |
    ...
    | Environment | SweatBox |
    | Duration | 1 - 1.5 hours |
    | Objectives | 1. Discuss the purpose of flow management techniques including the use of CTOTs and MDIs</br>2.
    Discuss the benefits of introducing flow control</br>3. Introduce the use of flow management techniques during high
    traffic scenarios</br>4. Review the course aims and consolidate knowledge in preparation for the exam</br>5. In most
    situations forward to exam, even if you are unsure as to whether they will pass (if you think they will more likely
    fail then do one further consolidation session) |
    | Student notes and resources | [S1 - Aerodrome Control e-learning
    course](https://moodle.vatsim.uk/course/view.php?id=67)</br>[Aeronautical Chart
    Symbols](https://www.aurora.nats.co.uk/htmlAIP/Publications/2021-01-28-AIRAC/html/eAIP/EG-GEN-2.3-en-GB.html#GEN-2.3)</br>[Standard
    Route Document (SRD)](https://nats-uk.ead-it.com/cms-nats/opencms/en/Publications/digital-datasets/)</br>[UKCP SRD
    search](https://ukcp.vatsim.uk/srd-routes)</br>[eAIP](https://nats-uk.ead-it.com/cms-nats/opencms/en/Publications/AIP/)
    |
