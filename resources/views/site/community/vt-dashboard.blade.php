					...
					<ul>
						<li>
							All Transferring/Visiting controllers are subject to the global&nbsp;<a
								href="https://vatsim.net/docs/policy/transfer-and-visiting-controller-policy/" rel="external nofollow"
								target="_blank">VATSIM&nbsp;Transfer &amp; Visiting
								Controller Policy</a>&nbsp;and <a href="https://www.vatsim.uk/policy/division-policy" rel="">VATSIM
								UK Division
								Policy</a>;
						</li>
						<li>
													...
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																<form action="{{ route('visiting.application.withdraw.post', [$application->public_id]) }}"
																	method="POST">
																	@csrf
