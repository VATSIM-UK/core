        ...
        <div class="col-md-3 col-md-push-9">
                    ...
                    <ul>
                        <li>
                            All Transferring/Visiting controllers are subject to the global&nbsp;<a
                                ...
                                Controller Policy</a>&nbsp;and <a href="https://www.vatsim.uk/policy/division-policy"
                                rel="">VATSIM
                                UK Division
                                Policy</a>;
                        </li>
            ...
            <div class="panel panel-ukblue">
                ...
                <div class="panel-body">
                    ...
                    <p>
                        All UK APP + ADC positions with the exception of those listed in the ATC Training Policy as
                        requiring an additional endorsement.
                    </p>
                    ...
                    <p>
                        All UK CTR + APP + ADC positions with the exception of those listed in the ATC Training Policy as
                        requiring an additional endorsement.
                    </p>
                ...
                <div class="col-md-12">
                    <div class="panel panel-ukblue">
                        ...
                        <div class="panel-body">
                            ...
                            <p>You will be treated as if you have no rating at all. You will complete the entire OBS/S1
                                training from the start, first waiting for a seminar with available capacity, followed by
                                completing mentoring sessions and
                                lastly followed by a practical exam, which you must pass in order to complete your transfer.
                                <a href="{{ route('site.atc.newController') }}" target="_blank">You can view our New
                                    Controller page here.</a>
                                After applying, you will be placed on the waiting list, you do not need to carry out any
                                additional steps to join one. Expect a long wait period.
                            </p>
                            <p>
                                <strong>If you hold the rating of S2+ (Transfer) and S3+ (Visiting)</strong>
                            </p>
                            <p><strong>No training will be provided.</strong> Upon being accepted, you will be given access
                                to our theory resources to complete some self study and placed on the waiting list for a
                                practical validation.
                                When a place is available, we will require evidence of sufficient self study being completed
                                before granting you solo validations to control positions relevant to your rating,
                                You will be able to complete 10 hours of solo time before being put forward for a validation
                                attempt.</p>
                            <p>It is entirely up to you to manage your own study schedule and complete the required elements
                                within the time period provided.</p>
                            <p>Expect a short wait period for transfers and a long wait period for visiting applications.
                            </p>
                            <p class="text-decoration-underline">
                                <u><strong>Pilot Visiting</strong></u>
                            </p>
                            <p>You will be placed on the waiting list. When a spot is available you will receive full
                                training inline with home members.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="panel panel-ukblue">
                        ...
                        <div class="panel-body">
                            ...
                            <p>We offer a range of pilot training opportunities including gaining your pilot rating and our
                                "The Flying Program (TFP)" which helps members learn the vital skills required to fly on the
                                network.</p>
                            <p>
                            ...
                            <p class="text-center">
                                ...
                                @else
                                    @can('create', new \App\Models\VisitTransfer\Application())
                                        <a
                                            href="{{ route('visiting.application.start', [\App\Models\VisitTransfer\Application::TYPE_VISIT, 'pilot']) }}">
                                            <button
                                                class="btn btn-success">{{ trans('application.dashboard.apply.pilot.visit.start') }}</button>
                                        </a>
                                    @elseif($currentVisitApplication && $currentVisitApplication->is_in_progress && $currentVisitApplication->is_pilot)
                                        <a
                                            href="{{ route('visiting.application.continue', [$currentVisitApplication->public_id]) }}">
                                            <button class="btn btn-primary"
                                                href="">{{ trans('application.continue') }}</button>
                                        </a>
                ...
                <div class="col-md-4">
                    <div class="panel panel-ukblue">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                VATSIM UK <strong>does not accept</strong> visiting applications from S1 or S2 rated
                                controllers as per the Global Transfer and Visiting Controller Policy. You are welcome to
                                apply for a full transfer.</p>

                            <p>
                                Visiting controllers should select the facility related to their rating. C1 Visitors may
                                also apply in a separate application for the Oceanic endorsement by submitting a ticket to
                                the Visit/Transfer option within&nbsp;our helpdesk.&nbsp;
                            </p>
                            <p>
                            ...
                            <p class="text-center">
                                ...
                                @else
                                    @can('create', new \App\Models\VisitTransfer\Application())
                                        ...
                                        @else
                                            <a
                                                href="{{ route('visiting.application.start', [\App\Models\VisitTransfer\Application::TYPE_VISIT, 'atc']) }}">
                                                <button
                                                    class="btn btn-success">{{ trans('application.dashboard.apply.atc.visit.start') }}</button>
                                            </a>
                                        @endif
                                    @else
                                        <button class="btn btn-danger"
                ...
                <div class="col-md-4">
                    <div class="panel panel-ukblue">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                OBS Rated members can transfer between divisions freely. You do not need to create an
                                application and should not use this system,
                                instead <a href="https://helpdesk.vatsim.uk/" rel="external nofollow" target="_blank">raise
                                    a ticket to
                            ...
                            <p class="text-center">
                                ...
                                @else
                                    @can('create', new \App\Models\VisitTransfer\Application())
                                        <a
                                            href="{{ route('visiting.application.start', [\App\Models\VisitTransfer\Application::TYPE_TRANSFER, 'atc']) }}">
                                            <button class="btn btn-success"
                                                href="">{{ trans('application.dashboard.apply.atc.transfer.start') }}</button>
                                        </a>
                                    @elseif($currentTransferApplication)
                                        <a
                                            href="{{ route('visiting.application.continue', [$currentTransferApplication->public_id]) }}">
                                    ...
                                    <tr>
                                        <td>
                                            @if ($application->is_in_progress)
                                                <a
                                                    href="{{ route('visiting.application.continue', [$application->public_id]) }}">{{ $application->public_id }}</a>
                                            @else
                                                <a
                                                    href="{{ route('visiting.application.view', [$application->public_id]) }}">{{ $application->public_id }}</a>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td class="hidden-xs hidden-sm">
                                            ...
                                            @else
                                                ...
                                                <span
                                                    class="visible-xs">{{ $application->submitted_at->toFormattedDateString() }}
                                                    UTC</span>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            @include('visit-transfer.partials.application_status', [
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('visiting.application.withdraw.post', [$application->public_id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <button type="submit" class="btn btn-danger">WITHDRAW
                                                                        APPLICATION - THIS CANNOT BE UNDONE</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
