<x-markdown>
    ...
    Our controllers will always send you a **contact me** if you are entering their airspace. However, you can use the
    diagrams below or [**VATGlasses**](https://vatglasses.uk/ukireland/) if you want to know when to call them in
    advance.
    ...
    **Key Points:**
    ...
    <img class="img-responsive center-block" src="/images/egtc-sectors-2023-11.png"
        alt="diagram of London TMA split sectors">
    ...
    <img class="img-responsive center-block" src="/images/egpx-sectors-2023-11.png"
        alt="diagram of main Scottish sectors">
