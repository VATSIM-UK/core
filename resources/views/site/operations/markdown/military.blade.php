<x-markdown>
    ...
    If you are departing from a military airfield and joining controlled airspace in the same way civilian air traffic
    does,
    you must get a **joining clearance** from the relevant civilian area sector **before you enter controlled
    airspace**.
    If you are unsure who to contact, please ask a controller or check
    [**VATGlasses**](https://vatglasses.uk/ukireland/).
</x-markdown>
