...
<head>
    ...
    <script src="https://slug.vatsim.uk/script.js" data-site="HQWHPBQX" data-included-domains="vatsim.uk,www.vatsim.uk"
        defer></script>
...
<body>
            ...
            <div class="row align-items-center h-100">
                ...
                <div class="col-md-8 mx-auto text-center py-8 grow">
                    @if (currentUserHasAuth() && $_account->hasState('DIVISION'))
                        ...
                        <p class="lead mt-5 my-0">Did you know you're one of {{ $stats['members_division'] }} members
                            of
                            VATSIM UK?</p>
                        <hr class="w-10 my-7">
                    ...
                    @elseif(currentUserHasAuth())
                        ...
                        <p class="lead"><a href="{{ route('visiting.landing') }}" class="text-white">Click here to
                                learn
                                more!</a></p>
                        <hr class="w-10 my-7">
                        <a class="btn btn-xl btn-round btn-primary px-7" href="{{ route('landing') }}">Enter</a>
                    @else
                        ...
                        <p class="lead mt-5"> We pride ourselves in providing regular and high quality air traffic
                            control
                            for our pilots.</p>
                        <hr class="w-10 my-7">
    ...
    <section class="section bg-gray overflow-hidden">
        ...
        <div class="container">
            ...
            <p>
                VATSIM UK is the place to be for any members who regularly fly or wish to control on the VATSIM Network
                in
                ...
                community of flight simulation enthusiasts - whether you are a student longing for a career in aviation,
                a
            ...
            <p>
                ...
                Discord server and take advantage of the wealth of knowledge within our community. We also offer a
                bespoke
            ...
            <p>
                Joining VATSIM UK has given me everything from new friends and memorable trips, to career advice and
                flying
                tips. I hope that everyone is able to benefit from our incredible community just as much as I have and I
                can
                ...
                @if (currentUserHasAuth())
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 mb-3">
                                <a class="btn btn-xl btn-round btn-primary px-7"
                                    href="https://moodle.vatsim.uk">Moodle</a>
                            </div>
                ...
                @else
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <a class="btn btn-l btn-round btn-primary px-7"
                                    href="{{ route('site.join') }}">Join</a>
                            </div>
                        </div>
                    </div>
                @endif
    ...
    <!-- Scripts -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jarallax/1.10.3/jarallax.min.js"
        integrity="sha512-1RIeczLHpQNM864FPmyjgIOPQmljv9ixHg5J1knRhTApLpvxqA0vOTxgGF89/DpgZIAXRCn9dRiakPjyTUl9Rg=="
