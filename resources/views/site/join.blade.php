            ...
            <div class="panel panel-ukblue">
                ...
                <div class="panel-body">
                    ...
                    <p>
                        ...
                        a
                        copy of Flight Simulator, Prepar3D or X Plane, and you're ready to go! For controlling, you don't
                        need
    ...
    <div class="row row-flex">
        ...
        <div class="col-md-4 col-md-offset-1">
            <div class="panel panel-ukblue">
                ...
                <div class="panel-body">
                    <h4>Step 1</h4>
                    <p>Visit <a href="https://my.vatsim.net/register">VATSIM.net</a> and register for your ID and password.
                        This is a very quick process and is
        ...
        <div class="col-md-4 col-md-offset-2">
            <div class="panel panel-ukblue">
                ...
                <div class="panel-body">
                    ...
                    <h4>Step 2</h4>
                    <p>Download an <a href="https://my.vatsim.net/learn/vatsim-basics/section/5">approved pilot client</a>.
                        These are the free pieces of software you will use to
                        connect
                        your flight simulator to VATSIM.</p>

                    <h4>Step 3</h4>
                    <p>Visit the <a href="https://vatsim.net/docs/basics/getting-started">Getting Started Guide</a> to get
                        started as a pilot on the
                        network. For
                        flying in the UK, our own <a href="{{ route('site.airports') }}">airport pages</a> contain some
                        great information and
                        resources.</p>

                    <h4>Step 4</h4>
                    <p>Consider reviewing the <a href="https://my.vatsim.net/pilots/train">Pilot Training</a> area of the
                        VATSIM.net Education Hub to enhance your pilot skills or join a
                        distinguished
                        virtual airline like <a href="https://bavirtual.co.uk/">BAVirtual</a>. If you prefer GA flying, you
                        might like to consider
                        visiting the
                        <a href="https://www.cixvfrclub.org.uk/">CIX VFR Club</a>.
                    </p>
