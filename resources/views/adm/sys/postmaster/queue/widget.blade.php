<table id="mship-accounts" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if($q->status != \App\Models\Sys\Postmaster\Queue::STATUS_PENDING)
                            ...
                            <td align="center">
                                @if($q->priority == \App\Models\Sys\Postmaster\Template::PRIORITY_LOW)
                                <span class="label label-default">Low</span>
                                @elseif($q->priority == \App\Models\Sys\Postmaster\Template::PRIORITY_MED)
                                <span class="label label-primary">Normal</span>
                                @elseif($q->priority == \App\Models\Sys\Postmaster\Template::PRIORITY_HIGH)
                                <span class="label label-warning">High</span>
                                @elseif($q->priority == \App\Models\Sys\Postmaster\Template::PRIORITY_NOW)
                            ...
                            <td align="center">
                                ...
                                @elseif($q->status == \App\Models\Sys\Postmaster\Queue::STATUS_PARSED)
                                <span class="label label-primary">Parsed</span>
                                @elseif($q->status == \App\Models\Sys\Postmaster\Queue::STATUS_DISPATCHED)
                                <span class="label label-success">Sent</span>
                                @elseif($q->status == \App\Models\Sys\Postmaster\Queue::STATUS_DELIVERED)
                                <span class="label label-success">Delivered</span>
                                @elseif($q->status == \App\Models\Sys\Postmaster\Queue::STATUS_CLICKED)
                                <span class="label label-success">Clicked</span>
                                @elseif($q->status == \App\Models\Sys\Postmaster\Queue::STATUS_OPENED)
                                <span class="label label-success">Opened</span>
                                @elseif($q->status == \App\Models\Sys\Postmaster\Queue::STATUS_DROPPED)
                                <span class="label label-warning">Dropped</span>
                                @elseif($q->status == \App\Models\Sys\Postmaster\Queue::STATUS_SPAM)
                                <span class="label label-warning">Spam</span>
                                @elseif($q->status == \App\Models\Sys\Postmaster\Queue::STATUS_UNSUBSCRIBED)
                                <span class="label label-warning">Unsubscribed</span>
                                @elseif($q->status == \App\Models\Sys\Postmaster\Queue::STATUS_BOUNCED)
