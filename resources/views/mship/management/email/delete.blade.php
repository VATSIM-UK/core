	...
	<div class="panel panel-ukblue">
		...
		<div class="panel-body text-center">
			...
			@if ($assignments->count() > 0)
				<p>
					Deleting this email will reset the following SSO assignments to their default value
					({{ \Auth::user()->email }})
				<div align="center">
			...
			<form action="{{ route('mship.manage.email.delete.post', $email->id) }}" class="form-horizontal" method="POST">
				...
				<div class="form-group">
					<button type="submit" class="btn btn-danger" name="" value="delete_email">Delete</button>
				</div>
			</form>
