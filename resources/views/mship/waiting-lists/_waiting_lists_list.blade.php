					...
					<tbody>
						@foreach ($waitingListAccounts as $waitingListAccount)
							<tr>
								...
								@endif
								<td>
									<button class="btn btn-danger" type="button" data-toggle="modal" data-target="#leaveConfirmModal"
							...
							<tr>
								...
								<td>
									@if (!$waitingList->isAtCapacity())
										<form action="{{ route('mship.waiting-lists.self-enrol', ['waitingList' => $waitingList]) }}"
											method="POST">
