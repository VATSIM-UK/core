...
@show
<p>
	If you keep experiencing this issue, please let the Technology team know by emailing <a
		href="mailto:technology-support@vatsim.uk">technology-support@vatsim.uk</a>.
	@if (Auth::check())
