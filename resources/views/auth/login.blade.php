    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p>
                        Please enter your second, VATSIM UK password below. You will be requested to enter this password in
                        any of the following situations:
                    <ol style="margin-left: 25px;">
                        <li>On your initial login to our system (after previously signing out, or being away for a long
                            period).</li>
                    ...
                    <p>
                        If you believe you are seeing this page too often, or erroneously, please contact the Technology
                        Team.
                    </p>
                </div>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <form action="{{ route('auth-secondary.post') }}" method="POST" class="form-horizontal">
                        ...
                        <div class='form-group'>
                            ...
                            <div class="col-sm-4">
                                <p class="form-control-static">{{ Auth::guard('vatsim-sso')->user()->id }} || <a
                                        href='#' class="form-control-static" data-toggle="modal"
                                        data-target="#notYou">Not You?</a></p>
                            </div>
                        </div>
                        ...
                        <div class='form-group'>
                            <div class="col-sm-4 col-sm-offset-5">
                                <a href='#' class="form-control-static" data-toggle="modal"
                                    data-target="#resetConfirmModal">Forgotten Password?</a>
                            </div>
                        </div>
        ...
        <div class="col-md-2">
            <div class="panel panel-uk-danger">
                ...
                <div class="panel-body">
                    Use your primary email address (*****<b>{{ '@' . explode('@', Auth::user()->email)[1] }}</b>) to send an
                    email to
