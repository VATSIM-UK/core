<div class="overflow-x-auto overflow-y-auto max-h-[600px] relative z-0 isolate rounded-lg border border-gray-200 dark:border-white/10 custom-scrollbar">
    <div class="flex flex-col min-w-max">
        ...
        <div class="flex sticky top-0 bg-gray-50 dark:bg-gray-800/95 backdrop-blur-sm z-30 shadow-sm border-b border-gray-200 dark:border-white/10">
            <div class="w-16 flex-shrink-0 sticky left-0 z-40 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-white/10 px-2 py-4 text-xs font-semibold text-gray-900 dark:text-white text-center">
                Time
            </div>
        ...
        <div class="flex relative">
            ...
            <div class="w-16 flex-shrink-0 sticky left-0 z-20 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-white/10 flex flex-col">
                @foreach($hours as $hour)
                    <div class="h-16 border-b border-gray-200 dark:border-white/5 text-[11px] text-center text-gray-500 font-medium pt-2">
            ...
            <div class="flex-1 flex divide-x divide-gray-200 dark:divide-white/5 relative z-10" style="height: {{ $totalHours * $rowHeightPixel }}px;">
                ...
                @foreach($students as $student)
                    <div class="flex-1 min-w-[140px] relative bg-inherit group hover:bg-gray-50/50 dark:hover:bg-white/5 transition duration-75">
