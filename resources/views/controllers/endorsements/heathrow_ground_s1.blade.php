			...
			<div class="panel panel-ukblue">
				...
				<div class="panel-body">
					...
					<div class="progress" data-toggle="tooltip" title="Hours on Gatwick DEL/GND">
						<div class="progress-bar {{ $gatwickMet ? 'progress-bar-success' : 'progress-bar-warning' }}" role="progressbar"
							style="width: {{ min(($gatwickHours / 30) * 100, 100) }}%" aria-valuemin="0" aria-valuemax="30">
					...
					<div class="progress" data-toggle="tooltip" title="Hours on Manchester DEL/GND">
						<div class="progress-bar {{ $manchesterMet ? 'progress-bar-success' : 'progress-bar-warning' }}" role="progressbar"
							style="width: {{ min(($manchesterHours / 30) * 100, 100) }}%" aria-valuemin="0" aria-valuemax="30">
					...
					<div class="progress" data-toggle="tooltip" title="Total hours on UK DEL/GND">
						<div class="progress-bar {{ $totalMet ? 'progress-bar-success' : 'progress-bar-warning' }}" role="progressbar"
							style="width: {{ min(($totalHours / 100) * 100, 100) }}%" aria-valuemin="0" aria-valuemax="100">
