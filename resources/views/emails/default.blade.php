                    ...
                    <table class="deviceWidth" style="background-color: rgb(23, 55, 94); width:100%" align="center" bgcolor="#17375e" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <a href="{{ route('site.home') }}"><img class="logo" width="200" style="border-radius: 0px; display: block;" alt="" src="{{ asset('images/vatsim_uk_logo.png') }}" unselectable="on" border="0"></a>
                                </td>
                            </tr>
                            <tr>
                                                    ...
                                                    <table class="deviceWidth" width="100%" border="0" cellpadding="10" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <a href="{{ route('site.home') }}"><img title="VATSIM UK Website" alt="VATSIM UK Website" src="{{ asset('images/earth.png') }}" unselectable="on" border="0" width="33"></a>
                                                                </td>
                                                                ...
                                                                <a href="{{ route('site.home') }}"><img class="logo" width="200" style="float:right;border-radius: 0px; display: block;" alt="" src="{{ asset('images/vatsim_uk_logo.png') }}" unselectable="on" border="0"></a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
