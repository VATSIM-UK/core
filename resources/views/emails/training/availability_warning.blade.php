...
@section('body')
    ...
    <p>To be fair to those students who are still waiting for training, if after three of these reminders, or after five
    ...
    <p>To submit your availability, please visit the Central Training System: <a
            href="https://cts.vatsim.uk">https://cts.vatsim.uk</a></p>

    <p>
        If you don’t have the time/don’t wish to continue with your training for the time being, please let us know by
        opening a ticket with the ATC Training team via the helpdesk:
