...
@section('body')
    ...
    <p>We write to inform you that you have been removed from your place on the ATC Training {{ $waiting_list->name }}
        Waiting List.
    ...
    <p>If you wish to query the specific details, appeal this matter or otherwise ask any questions, please raise a ticket
        for the attention of the ATC Training Team at the <a href="https://helpdesk.vatsim.uk">helpdesk</a>.</p>
