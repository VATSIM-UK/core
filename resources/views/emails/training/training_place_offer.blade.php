...
@section('body')
    ...
    <p>You can either accept this offer by clicking 'Accept Training Place' below, or reject it by clicking the 'Decline
        Training Place' link below.
    ...
    <p>If you are ready and able to begin your training, please let us know as soon as possible. By clicking 'Accept
        ...
        <a href="https://drive.google.com/file/d/1SKsHPvtfKxxvYchm1y37sw1Zq-8GsxMl/view?usp=drive_link">ATC Training
            Handbook</a> as well as Section 2 of the
        <a href="https://www.vatsim.uk/policy/atc-training-policy">ATC Training Policy</a>.
    </p>
