...
@section('body')
    ...
    <p>A secondary examiner may be appointed to assist in the conduct of the exam.
        The primary examiner remains responsible for the conduct of the exam and will brief you if a secondary examiner
        attends.
    </p>

    <p>You should remember that this is an <strong>open book exam</strong>, both for the practical and theoretical elements
        of the exam.
