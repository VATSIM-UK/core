...
@section('body')
    ...
    <p>A secondary examiner may be allocated either in support of complex exams or for training.
        ...
        You should consider whether or not to ping for adjacent ATC or pilots to support the exam in the relevant Discord
        channel.
        It is the responsibility of you as the primary examiner to arrange for these pings if required.
    </p>

    <p>You should brief the candidate at the beginning of the exam in accordance with the <a
            href="{{ __('atc.handbook.url') }}">ATC Training Handbook</a>.</p>

    <p>Should the candidate fail to attend, please notify the relevant TGI. In the event of either failure or success,
        feedback on the exam should be summarised to the training group in question.</p>
@endsection
