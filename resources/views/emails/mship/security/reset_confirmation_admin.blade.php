...
<p>To authorise this request, please <a href="{{ url('/mship/security/forgotten-link', ['code' => $token->code]) }}">click here</a>.  Alternatively, copy the link below into your browser:</p>
