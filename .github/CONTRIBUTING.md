...
Some issues simply can't be be delegated to outside contributors as they may require elevated access.
...
To run core locally, please read our setup guide [setup guide](https://github.com/VATSIM-UK/core/blob/main/.github/setup.md)
