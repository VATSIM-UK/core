            ...
            <div class="content">
                ...
                <div class="row-fluid">
                    <div class="span6 offset2">
                        <form class="form-horizontal form-login" method="POST" action="<?= URL::site("account/session/extra_security") ?>">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <button type="submit" class="btn">Validate Security Details</button>
                                </div>
                            </div>
                        </form>
                    </div>
