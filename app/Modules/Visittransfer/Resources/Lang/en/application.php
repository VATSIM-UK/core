...
return [
    ...
    "dashboard.apply.atc.visit.xfer_open" => "You currently have a transfer application open.",
    "dashboard.apply.atc.visit.unable" => "You are not able to apply to visit as visiting ATC at this time.",
