                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        @foreach(Auth::user()->visitTransferApplications as $app)
                            ...
                            <li role="presentation" {!! (Route::is("visiting.application.view") && $application->id == $app->id ? "class='active'" : "") !!}>
                                {{ link_to_route("visiting.application.view", "#".$app->id." - ".$app->type_string." ".$app->facility->name, [$app->id], ["class" => (Route::is("visiting.application.view")  && $application->id == $app->id ? "active" : "")]) }}
                            </li>
