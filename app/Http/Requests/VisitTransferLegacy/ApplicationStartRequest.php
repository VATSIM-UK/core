...
class ApplicationStartRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'terms_not_staff' => 'required_if:application_type,'.\App\Models\VisitTransferLegacy\Application::TYPE_TRANSFER,
            'application_type' => 'required|in:'.\App\Models\VisitTransferLegacy\Application::TYPE_TRANSFER.','.\App\Models\VisitTransferLegacy\Application::TYPE_VISIT,
