    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('start_at')->label('Start')->dateTime()->since()->tooltip(fn ($record) => $record->start_at)->sortable(),
                Tables\Columns\TextColumn::make('end_at')->label('End')->dateTime()->since()->tooltip(fn ($record) => $record->end_at),
