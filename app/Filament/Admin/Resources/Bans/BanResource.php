    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('period_finish')->label('Ends')->description(fn ($record) => $record->period_finish ? $record->period_finish->toDayDateTimeString() : 'Permanent')->getStateUsing(fn ($record) => $record->period_finish ? $record->period_finish->diffForHumans() : 'Never')->sortable(),
