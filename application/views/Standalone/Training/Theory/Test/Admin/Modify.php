...
<div class="row">
    <form class="form-horizontal" method="POST" action="<?= URL::site("training/theory_test_admin/modify/" . $test->id) ?>" role="form">
        <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" id="time_expire_action" name="time_expire_action">
                            <option value="FORFEIT" <?= ($_request->post("time_expire_action") == "FORFEIT" ? "selected='selected'" : ($test->time_expire_action == "FORFEIT" ? "selected" : "")) ?>">Foreit, scoring ZERO.</option>
                            <option value="SUBMIT" <?= ($_request->post("time_expire_action") == "FORFEIT" ? "selected='selected'" : ($test->time_expire_action == "FORFEIT" ? "selected" : "")) ?>">Submit, scoring for any answered questions.</option>
                        </select>
                    </div>
                </div>
            </div>
                            ...
                            <td>
                                <select class="form-control input-sm" name="category_id[]">
                                    ...
                                    <?php foreach ($categories as $c): ?>
                                        <option value="<?= $c->id ?>" <?= ($tc->category_id == $c->id) ? "selected='selected'" : "" ?>><?= $c->name ?></option>
                                    <?php endforeach; ?>
                                </select></td>
                            <td>
