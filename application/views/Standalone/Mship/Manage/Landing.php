...
<p>
    This page will redirect you automatically in <span id='timerCount'>10</span> seconds.  If you don't wish to wait, you can <?=HTML::anchor("/mship/auth/login", "start your login now")?>.
</p>
    ...
    $( document ).ready(function() {
        ...
        function runTimer(){
            if(timeLeft > 0){
                ...
                window.location.replace("<?=URL::site("/mship/auth/login")?>");
            }
        }
        setTimeout(runTimer, 1000);
    });
