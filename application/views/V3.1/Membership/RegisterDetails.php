...
<form class="form-horizontal" action="<?= URL::site("account/register_details") ?>" method="POST">
    ...
    <?php endif; ?>
    <div class="form-group <?=((isset($errors) && in_array("name_first", $errors)) ? "error" : "")?>">
        <label class="col-sm-2 control-label" for="name_first">First Name</label>
        <div class="col-sm-8">
    ...
    <div class="form-group <?=((isset($errors) && in_array("name_last", $errors)) ? "error" : "")?>">
        <label class="col-sm-2 control-label" for="name_last">Surname</label>
        <div class="col-sm-8">
    ...
    <div class="form-group <?=((isset($errors) && in_array("gender", $errors)) ? "error" : "")?>">
    ...
    <div class="form-group <?=((isset($errors) && in_array("dob", $errors)) ? "error" : "")?>">
    ...
    <div class="form-group <?=((isset($errors) && in_array("model/accountemail.email.email_check_unique", $errors)) ? "error" : "")?>">
    ...
    <div class="form-group <?=((isset($errors) && in_array("password", $errors)) ? "error" : "")?>">
        <label class="col-sm-2 control-label" for="password">Desired Password</label>
        <div class="col-sm-8">
