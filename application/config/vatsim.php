...
return array(
	...
	'autotools_url_divdb'  => '{autotools_url}divdbfullwpilot.php?{autotools_auth}&div={config.auth.autotools.division}',
	'autotools_url_regdb'  => '{autotools_url}divdbfullwpilot.php?{autotools_auth}&reg={config.auth.autotools.region}',
	'autotools_url_ratch'  => '{autotools_url}ratch.php?{autotools_auth}&div={config.auth.autotools.division}&rating=%1$u',
