...
class Model_Account_Main extends Model_Master {
    ...
    /**
     * Determine whether a user is suspended (from the network)
     * 
     * @return boolean True if banned, false otherwise.
     */
    public function isSuspended() {
        return $this->isStatusFieldSet(Enum_Account_Status::SYSTEM_BANNED);
    }

    /**
     * Determine whether a user is banned (from our systems)!
     * 
     * @return boolean True if banned, false otherwise.
     */
    public function isBanned() {
        return $this->isStatusFieldSet(Enum_Account_Status::NETWORK_SUSPENDED);
    }
