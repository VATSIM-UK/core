...
class Controller_Sso_Auth extends Controller_Master {
    ...
    private function security(){
        ...
        if(Session::instance(ORM::factory("Setting")->getValue("system.session.type"))->get("sso_token", null) != null){
    ...
    public function action_logout(){
        ...
        Session::instance(ORM::factory("Setting")->getValue("system.session.type"))->set("logout_url", $this->request->query("returnURL"));
