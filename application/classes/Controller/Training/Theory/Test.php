...
class Controller_Training_Theory_Test extends Controller_Training_Master {
    /**
    ...
    public function action_admin_modify() {
        ...
        if ((!$test->loaded() OR $test->deleted) && !$create) {
            ...
            $this->redirect("training/theory_test/admin_list");
            return false;
        }
        ...
        if (HTTP_Request::POST == $this->request->method()) {
            ...
            if ($create) {
                ...
                $this->redirect("training/theory_test/admin_modify/".$test->id);
                return true;
            } else {
                $test->edit_test($opt);
                $test->edit_test_categories($cats);
